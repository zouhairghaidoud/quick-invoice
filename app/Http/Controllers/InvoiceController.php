...
class InvoiceController extends Controller
{
    ...
    public function update(Request $request, Invoice $invoice)
    {
        $request->validate([
            ...
            'discount_value' => $request->has_discount == true ? 'required|numeric' : 'nullable',
            'has_tax' => 'required|boolean',
            'tax_type' => 'required',
            'tax_value' => $request->has_tax == true ? 'required|numeric' : 'nullable',
            'has_shipping' => 'required|boolean',
            'shipping_amount' => $request->has_shipping == true ? 'required|numeric' : 'nullable',
        ...
        $invoice->update([
            ...
            'discount_value' => $request->has_discount == true ? $request->discount_value : 0,

            'has_tax' => $request->has_tax,
            'tax_type' => $request->tax_type,
            'tax_value' => $request->has_tax == true ? $request->tax_value : 0,

            'has_shipping' => $request->has_shipping,
            'shipping_amount' => $request->has_shipping == true ? $request->shipping_amount : 0,
